  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: isLoading
          ...
          : ListView.builder(
              itemCount: ministryPartners.isNotEmpty ? ministryPartners.length + 2 : 1, // Adjust item count
              itemBuilder: (context, index) {
                if (index == 0 && ministryPartners.isNotEmpty) {
                ...
                } else if (index == ministryPartners.length + (ministryPartners.isNotEmpty ? 1 : 0)) {
